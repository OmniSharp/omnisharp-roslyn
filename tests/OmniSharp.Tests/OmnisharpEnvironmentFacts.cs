...
namespace OmniSharp.Tests
{
    public class OmnisharpEnvironmentFacts
    {
        ...
        {
            var environment = new OmnisharpEnvironment(@"foo.sln", 1000, -1, LogLevel.Information);
        ...
        {
            var environment = new OmnisharpEnvironment(@"c:\foo\src\", 1000, -1, LogLevel.Information);
