...
namespace OmniSharp.Tests
{
    public class OmniSharpEnvironmentFacts
    {
        ...
        {
            var environment = new OmniSharpEnvironment(TestAssets.Instance.OmniSharpSolutionPath, 1000, LogLevel.Information, 0, null);
        ...
        {
            var environment = new OmniSharpEnvironment(TestAssets.Instance.RootFolder, 1000, LogLevel.Information, 0, null);
