...
namespace OmniSharp.Roslyn.CSharp.Tests
{
    public class RenameFacts
    {
        ...
        public async Task Rename_UpdatesWorkspaceAndDocumentText()
        {
            ...
            var workspace = WorkspaceHelpers.CreateSimpleWorkspace(fileContent, "test.cs");
        ...
        public async Task Rename_UpdatesMultipleDocumentsIfNecessary()
        {
            ...
            var workspace = WorkspaceHelpers.CreateSimpleWorkspace(new Dictionary<string, string> { { "test1.cs", file1 }, { "test2.cs", file2 } });
        ...
        public async Task Rename_DoesTheRightThingWhenDocumentIsNotFound()
        {
            ...
            var workspace = WorkspaceHelpers.CreateSimpleWorkspace(fileContent);
