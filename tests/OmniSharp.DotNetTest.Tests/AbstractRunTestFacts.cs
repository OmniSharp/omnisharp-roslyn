...
{
    public abstract class AbstractRunTestFacts : AbstractSingleRequestHandlerTestFixture<RunDotNetTestService>
    {
        ...
        protected override string EndpointName { get; } = OmnisharpEndpoints.V2.RunDotNetTest;
