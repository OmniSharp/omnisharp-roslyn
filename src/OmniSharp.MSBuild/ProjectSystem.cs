...
namespace OmniSharp.MSBuild
{
    ...
    internal class ProjectSystem : IProjectSystem
    {
        ...
        private static string FindSolutionFilePath(string rootPath, ILogger logger)
        {
            ...
            // this causes collecting unexpected files like 'x.slnx'.
            ...
            var solutionsFilePaths = Directory.GetFiles(rootPath, "*.sln")
                .Where(x =>
                {
                    ...
                    return ext.Equals(".sln", StringComparison.OrdinalIgnoreCase) || ext.Equals(".slnproj", StringComparison.OrdinalIgnoreCase);
                }).ToArray();
