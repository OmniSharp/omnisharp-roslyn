...
namespace OmniSharp.MSBuild
{
    ...
    internal class ProjectSystem : IProjectSystem
    {
        ...
        public void Initalize(IConfiguration configuration)
        {
            ...
            _manager = new ProjectManager(_loggerFactory, _eventEmitter, _fileSystemWatcher, _metadataFileReferenceCache, _packageDependencyChecker, _loader, _workspace, _codeFixesForProjects, _rulesetsForProjects, _assemblyLoader, _eventSinks);
