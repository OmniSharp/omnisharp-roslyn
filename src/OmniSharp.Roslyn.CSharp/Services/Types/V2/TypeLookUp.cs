...
namespace OmniSharp.Roslyn.CSharp.Services.Types.V2
{
    [OmniSharpHandler(OmniSharpEndpoints.V2.TypeLookup, LanguageNames.CSharp)]
        ...
        public async Task<TypeLookupResponse> Handle(TypeLookupRequest request)
        {
            ...
            if (document != null)
            {
                ...
                if (symbol != null)
                {
                    ...
                    {
                        response.DocComment = DocumentationConverter.ConvertDocumentationObject(symbol.GetDocumentationCommentXml(), _formattingOptions.NewLine);
                    }
                }
            }
