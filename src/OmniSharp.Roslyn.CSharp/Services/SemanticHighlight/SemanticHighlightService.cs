    ...
    public class SemanticHighlightService : IRequestHandler<SemanticHighlightRequest, SemanticHighlightResponse>
    {
        ...
        public static readonly Dictionary<string, SemanticHighlightClassification> _classificationMap =
            new()
            {
                ...
                [ClassificationTypeNames.ClassName] = SemanticHighlightClassification.Class,
                [ClassificationTypeNames.RecordClassName] = SemanticHighlightClassification.Class,
                [ClassificationTypeNames.DelegateName] = SemanticHighlightClassification.Delegate,
                [ClassificationTypeNames.EnumName] = SemanticHighlightClassification.Enum,
                [ClassificationTypeNames.InterfaceName] = SemanticHighlightClassification.Interface,
                [ClassificationTypeNames.ModuleName] = SemanticHighlightClassification.Namespace,
                [ClassificationTypeNames.StructName] = SemanticHighlightClassification.Struct,
                [ClassificationTypeNames.RecordStructName] = SemanticHighlightClassification.Struct,
                [ClassificationTypeNames.TypeParameterName] = SemanticHighlightClassification.TypeParameter,
                [ClassificationTypeNames.FieldName] = SemanticHighlightClassification.Field,
                [ClassificationTypeNames.EnumMemberName] = SemanticHighlightClassification.EnumMember,
                [ClassificationTypeNames.ConstantName] = SemanticHighlightClassification.Constant,
                [ClassificationTypeNames.LocalName] = SemanticHighlightClassification.Variable,
                [ClassificationTypeNames.ParameterName] = SemanticHighlightClassification.Parameter,
                [ClassificationTypeNames.MethodName] = SemanticHighlightClassification.Method,
                [ClassificationTypeNames.ExtensionMethodName] = SemanticHighlightClassification.Method,
                [ClassificationTypeNames.PropertyName] = SemanticHighlightClassification.Property,
                [ClassificationTypeNames.EventName] = SemanticHighlightClassification.Event,
                [ClassificationTypeNames.NamespaceName] = SemanticHighlightClassification.Namespace,
                [ClassificationTypeNames.LabelName] = SemanticHighlightClassification.Label,
                [ClassificationTypeNames.XmlDocCommentAttributeName] = SemanticHighlightClassification.XmlDocCommentAttribute,
                ...
                [ClassificationTypeNames.XmlDocCommentName] = SemanticHighlightClassification.XmlDocComment,
                ...
                [ClassificationTypeNames.XmlLiteralAttributeName] = SemanticHighlightClassification.XmlLiteralAttribute,
                ...
                [ClassificationTypeNames.XmlLiteralName] = SemanticHighlightClassification.XmlLiteral,
